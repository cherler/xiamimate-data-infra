...
-- >>> BEGIN migrations/sync/060_sync_candidate_expansion_jobs.sql
...
-- <<< END migrations/sync/060_sync_candidate_expansion_jobs.sql

-- >>> BEGIN migrations/sync/061_sync_opportunity_discovery_jobs.sql
...
-- <<< END migrations/sync/061_sync_opportunity_discovery_jobs.sql
